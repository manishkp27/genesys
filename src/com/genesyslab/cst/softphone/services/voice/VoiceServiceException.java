...
/*
 * This is a custom exception type used by VoiceService.
 * 
 * @author <a href="mailto:Chris.Munn@genesyslab.com">Chris Munn</a>
 */
public class VoiceServiceException extends Exception {
    
    public VoiceServiceException(final String message) {
        super(message);
    }
    
    public VoiceServiceException(final Throwable cause) {
        super(cause);
    }
    
    public VoiceServiceException(final String message, final Throwable cause) {
        super(message, cause);      
    }
}
